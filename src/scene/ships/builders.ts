...
export const SHIP_SPECS: Record<PieceType, ShipSpec> = {
  p: { length: 0.42, beam: 0.16, maxTilt: (8 * Math.PI) / 180, bobScale: 1.0 },
  n: { length: 0.6, beam: 0.14, maxTilt: (7 * Math.PI) / 180, bobScale: 0.9 },
  b: { length: 0.68, beam: 0.18, maxTilt: (6 * Math.PI) / 180, bobScale: 0.8 },
  r: { length: 0.72, beam: 0.28, maxTilt: (4 * Math.PI) / 180, bobScale: 0.6 },
  q: { length: 0.78, beam: 0.34, maxTilt: (3 * Math.PI) / 180, bobScale: 0.5 },
  k: { length: 0.7, beam: 0.24, maxTilt: (4 * Math.PI) / 180, bobScale: 0.7 },
};
